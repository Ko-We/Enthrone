...
public class ThroneStatTemplateMgr : MUIBase<ThroneStatTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public ThroneStatTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    ThroneStatTemplate pTemplate = new ThroneStatTemplate(listDetail);
    ...
    public ThroneStatTemplate GetTemplate(int _Index)
    {
        List<ThroneStatTemplate> listTemplate = GetTList();
