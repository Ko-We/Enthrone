...
public class AntiqueItemTemplateMgr : MUIBase<AntiqueItemTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public AntiqueItemTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    AntiqueItemTemplate pTemplate = new AntiqueItemTemplate(listDetail);
    ...
    public AntiqueItemTemplate GetTemplate(int _Index)
    {
        List<AntiqueItemTemplate> listTemplate = GetTList();
