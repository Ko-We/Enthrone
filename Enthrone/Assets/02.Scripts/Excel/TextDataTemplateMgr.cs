...
public class TextDataTemplateMgr : MUIBase<TextDataTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public TextDataTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    TextDataTemplate pTemplate = new TextDataTemplate(listDetail);
    ...
    public TextDataTemplate GetTemplate(int _Index)
    {
        List<TextDataTemplate> listTemplate = GetTList();
