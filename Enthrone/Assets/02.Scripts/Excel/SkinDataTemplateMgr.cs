...
public class SkinDataTemplateMgr : MUIBase<SkinDataTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public SkinDataTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    SkinDataTemplate pTemplate = new SkinDataTemplate(listDetail);
    ...
    public SkinDataTemplate GetTemplate(int _Index)
    {
        List<SkinDataTemplate> listTemplate = GetTList();
