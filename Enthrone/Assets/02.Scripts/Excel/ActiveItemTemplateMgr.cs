...
public class ActiveItemTemplateMgr : MUIBase<ActiveItemTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public ActiveItemTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    ActiveItemTemplate pTemplate = new ActiveItemTemplate(listDetail);
    ...
    public ActiveItemTemplate GetTemplate(int _Index)
    {
        List<ActiveItemTemplate> listTemplate = GetTList();
