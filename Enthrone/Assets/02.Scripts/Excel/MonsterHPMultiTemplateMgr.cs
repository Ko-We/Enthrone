...
public class MonsterHPMultiTemplateMgr : MUIBase<MonsterHPMultiTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public MonsterHPMultiTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    MonsterHPMultiTemplate pTemplate = new MonsterHPMultiTemplate(listDetail);
    ...
    public MonsterHPMultiTemplate GetTemplate(int _Index)
    {
        List<MonsterHPMultiTemplate> listTemplate = GetTList();
