...
public class AttendanceTemplateMgr : MUIBase<AttendanceTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public AttendanceTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    AttendanceTemplate pTemplate = new AttendanceTemplate(listDetail);
    ...
    public AttendanceTemplate GetTemplate(int _Index)
    {
        List<AttendanceTemplate> listTemplate = GetTList();
