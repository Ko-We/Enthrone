...
public class ThroneSkillTemplateMgr : MUIBase<ThroneSkillTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public ThroneSkillTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    ThroneSkillTemplate pTemplate = new ThroneSkillTemplate(listDetail);
    ...
    public ThroneSkillTemplate GetTemplate(int _Index)
    {
        List<ThroneSkillTemplate> listTemplate = GetTList();
