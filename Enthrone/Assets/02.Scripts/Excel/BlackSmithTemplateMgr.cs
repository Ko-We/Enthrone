...
public class BlackSmithTemplateMgr : MUIBase<BlackSmithTemplate>
{
    string TextResource;
    bool flagDataLoad;

    public BlackSmithTemplateMgr()
    {
        flagDataLoad = false;
    }
    ...
    public void OnDataLoad(string _textResource)
    {
        ...
        if (Data != "")
        {
            ...
            for (int nCnt = 1; nCnt < list.Length; nCnt++)
            {
                ...
                {
                    BlackSmithTemplate pTemplate = new BlackSmithTemplate(listDetail);
    ...
    public BlackSmithTemplate GetTemplate(int _Index)
    {
        List<BlackSmithTemplate> listTemplate = GetTList();
